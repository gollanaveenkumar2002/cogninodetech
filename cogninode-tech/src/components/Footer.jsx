        ...
        <footer className="bg-gray-900 text-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <div className="flex flex-col">
                                <span className="text-xl font-bold">Cogninode</span>
                                <span className="text-xs text-gray-400">Technologies</span>
                            </div>
                        </div>
                        <p className="text-gray-400 mb-4 max-w-md">
                            Leading provider of cutting-edge Cybersecurity solutions and AI Tools & Solutions.
                        ...
                        <ul className="space-y-3 text-gray-400">
                            <li className="flex items-start space-x-2">
                                ...
                                <span className="text-sm">
                                    R-Cube Co-working Space, Ayyappa Society, Madhapur, Hyderabad
                                </span>
                            </li>
                            <li className="flex items-center space-x-2">
                                ...
                                <span className="text-sm">info@cogninode.tech</span>
                            </li>
                            <li className="flex items-center space-x-2">
                                <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
                    <p>&copy; {currentYear} Cogninode Technologies. All rights reserved.</p>
                </div>
            </div>
        </footer>
    )
